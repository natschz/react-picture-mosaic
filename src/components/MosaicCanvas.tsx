...
export const drawCanvasImage = (canvas: any, image: MosaicImage, index: number, columns: number, rows: number, gridRect: DOMRect, drawTileToCanvas) => {
...
interface MosaicCanvasProps {
  ...
  setCanvasRef: (HTMLCanvasElement) => void
}
